    ...
    PROFILES = {
        "development": {
            ...
            "warnings": [
                ...
                "[WARN] Warning: All users have admin access",
                "[WARN] Do NOT expose to internet",
            ],
            "config": {
                ...
                "compliance": {"gdpr": False, "hipaa": False, "soc2": False},
            },
        },
        "production_basic": {
            "tier": 1,
            ...
            "config": {
                ...
                "security": {
                    ...
                    "authentication": {
                        "enabled": True,
                        "method": "api_key",
                        "api_key": {"length": 32, "expiration": "90d"},
                    },
                    "authorization": {
                        "enabled": True,
                        "method": "rbac",
                    ...
                    "rate_limiting": {
                        "enabled": True,
                        "strategy": "simple",
                        "limits": {"rps": 10, "rpm": 100},
                    },
                    "audit_logging": {
                        "enabled": True,
                        "level": "standard",
                        "tiered_storage": {"tier1": {"retention": "90d"}},
                    },
                ...
                "compliance": {"gdpr": "partial", "hipaa": False, "soc2": False},
            },
        },
        "production_enhanced": {
            "tier": 2,
            ...
            "config": {
                ...
                "security": {
                    ...
                    "defense": {
                        ...
                        "business_logic": {"export_quota": {"enabled": True}},
                    },
                },
                "compliance": {"gdpr": True, "soc2": True, "hipaa": "partial"},
            },
        },
        "production_maximum": {
            "tier": 3,
