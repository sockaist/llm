...
class RewardTracker:
    ...
    def add_reward(cls, strategy, reward):
        ...
        logger.info(f"[RewardTracker] Strategy '{strategy}' updated with reward {reward}")
...
class BanditHPTuner:
    ...
    def get_hp(self, query: str, context: str = "general"):
        ...
        if random.random() < self.epsilon:
            ...
            strategy_name = max(self.strategies.keys(), key=lambda s: RewardTracker.get_avg_reward(s))
