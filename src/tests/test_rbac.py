...
try:
    ...
    from llm_backend.server.vector_server.core.security.security_level_manager import (
    ...
    DOCS = [
        {
            "id": "doc_pub_1",
            "content": "Public Level 1 Content",
            "tenant_id": "public",
            "access_level": 1,
        },
        {
            "id": "doc_pub_3",
            "content": "Public Level 3 Content",
            "tenant_id": "public",
            "access_level": 3,
        },
        {
    ...
    def test_rbac_flow():
        ...
        print("[OK] User Visibility Verified")
        ...
        try:
            ...
            pub_doc_item = next(
                r for r in res_admin if r.get("payload", {}).get("id") == "doc_pub_1"
            )
            ...
            print("[FAIL] User A update succeeded (Should FAIL)")
            sys.exit(1)
        except PermissionError:
            print("[OK] User A update failed (Expected)")
        ...
        try:
            ...
            success = security_mgr.update_security_level(
                COLLECTION, db_id_pub_1, 4, ctx_admin
            )
            assert success, "Admin update returned False"
            print("[OK] Admin update succeeded")
                ...
                scroll_filter=models.Filter(
                    must=[
                        models.FieldCondition(
                            key="id", match=models.MatchValue(value=db_id_pub_1)
                        )
                    ]
                ),
                limit=1,
            ...
            print(f"[FAIL] Admin update failed: {e}")
            sys.exit(1)
        ...
        print("[OK] Security Level Management Verified")
