    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful assistant for expanding academic profiles.",
                },
        ...
        print(f"   [WARN] Error generating bio for {name}: {e}")
        return ""


async def main():
    print(f"[INFO] Starting Document Expansion for {TARGET_DIR}...")
