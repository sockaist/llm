...
async def analyze_health():
    ...
    research_queries = [q for q in queries if "csweb.research" in q.get("origin_collection", "") or "name:" in q["query"]]
    ...
    with acquire_manager() as mgr:
        ...
        for q in research_queries:
            target = q.get("expected_doc_ids", [])[0] if q.get("expected_doc_ids") else None
