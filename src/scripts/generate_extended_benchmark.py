...
async def generate_benchmark():
    print(f"[INFO] Generating Extended Benchmark (Target: {TARGET_COUNT} queries)...")
        ...
        for col_name in collections:
            ...
            try:
                ...
                hits, _ = mgr.client.scroll(
                    collection_name=col_name, limit=per_col + 20, with_payload=True
                )
    ...
    print(f"[OK] Generated {len(final_set)} queries in {output_path}")
