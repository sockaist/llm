    ...
    try:
        ...
        while True:
            try:
                ...
                #     if not is_valid:
                #         print("\\n[FAIL] 죄송합니다. 해당 질문은 KAIST 전산학부 관련 질문이 아닌 것 같습니다.")
                #         print("[TIP] 전산학부 학사과정, 행사, 교수진, 시설 등에 대해 질문해주세요.")
                #         continue
                ...
                try:
                    ...
                    try:
                        ...
                        print(f"[FAIL] 검색도 실패했습니다: {e2}")

            except KeyboardInterrupt:
                print("\\n\\n👋 챗봇을 종료합니다.")
                break
            except Exception as e:
                print(f"\\n[FAIL] 예상치 못한 오류가 발생했습니다: {e}")
                print("🔄 다시 시도해주세요.")

    except Exception as e:
        print(f"[FAIL] 시스템 초기화 실패: {e}")
